...
SO_TARGET_VERSION = 73.1
SO_TARGET_VERSION_MAJOR = 73
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt73
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt73 
ICUDATA_CHAR = l
...
CXXFLAGS =  -O2 -W -Wall -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long -std=c++11 -Wno-ambiguous-reversed-operator $(THREADSCXXFLAGS) -Qunused-arguments -Wno-parentheses-equality
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS = -I/usr/include $(THREADSCPPFLAGS)  -DU_HAVE_ELF_H=1 -DU_HAVE_STRTOD_L=1 -DU_HAVE_XLOCALE_H=0 
...
LDFLAGS = -L/usr/lib/x86_64-linux-gnu $(RPATHLDFLAGS)
